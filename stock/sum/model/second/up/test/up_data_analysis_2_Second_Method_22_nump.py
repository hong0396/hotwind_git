                    ...
                    if min(zong[i][open], zong[i+1][open],zong[i][close], zong[i+1][close]) >= max(zong[i+2][open], zong[i+3][open],zong[i+4][open],zong[i+2][close], zong[i+3][close],zong[i+4][close]):
                        if zong[i+2][close] == max(zong[i+2][open], zong[i+3][open],zong[i+4][open],zong[i+2][close], zong[i+3][close],zong[i+4][close]) : 
                                    if abs((zong[i][close] - zong[i][open])/zong[i][open]) < 0.03:
                                        if (zong[i+1][close] - zong[i+1][open])/zong[i+1][open] > 0 and abs((zong[i+1][close] - zong[i+1][open])/zong[i+1][open]) < 0.03:
                                            if (zong[i+2][close] - zong[i+2][open])/zong[i+2][open] > 0 and abs((zong[i+2][close] - zong[i+2][open])/zong[i+2][open]) < 0.03:                                       
                                                if abs((zong[i+3][close] - zong[i+3][open])/zong[i+3][open])< 0.03:
                                                    if abs((zong[i+4][close] - zong[i+4][open])/zong[i+4][open]) < 0.03:
                                                        if min(zong[i+2][open], zong[i+3][open],zong[i+4][open],zong[i+2][close], zong[i+3][close],zong[i+4][close])>0:
                                                            if zong[i-5][close]:
...
tmp_df.to_csv('E:/up_analysis_nump.csv',index=False)
