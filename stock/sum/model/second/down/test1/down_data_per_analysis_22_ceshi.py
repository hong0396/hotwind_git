                                                    ...
                                                    if zong[i+4][open] < zong[i+5][open]:
                                                        if zong[i+2][open] < zong[i+4][open]:
                                                            # if zong[i-5][close]:
                                                                ...
                                                                li_123_min=min(zong[i-1][close],zong[i-2][close])
                                                                li_123_tmp.append((li_123_min - zong[i][close])/zong[i][close])
                                                                    ...
                                                                    if (zong[i-2][close] - zong[i-2][open])/zong[i-2][open] < 0:
                                                                        if zong[i-2][open] < zong[i-1][open]:
                                                                            if zong[i-1][open] < zong[i][open]:
                                                                                if (li_123_min - zong[i][close])/zong[i][close]< -0.01:
                                                                                    tmp_123=1
                                                                                else:
                                                                                    tmp_123=0
...
tmp_df.to_csv('E:/test1_analysis_3.csv',index=False)
