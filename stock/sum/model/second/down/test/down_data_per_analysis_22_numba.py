...
def  get_data(zong,li):
                                                ...
                                                if (zong[i+3][close] - zong[i+3][open])/zong[i+3][open] < 0:
                                                    if (zong[i+4][close] - zong[i+4][open])/zong[i+4][open] > 0:
                                                            ...
                                                            if zong[i-5][close]:
                                                                ...
                                                                # li_num_tmp.append(zong[i+5]['time'])
                                                                # li_0_tmp.append(zong[i][close])
                                                                ...
                                                                ll_tmp=[grow0_tmp,grow1_tmp,grow2_tmp,grow3_tmp,grow4_tmp] 
                                                                ...
                                                                min_value=min(open0,open1,open2,open3,open4,close0,close1,close2,close3,close4)
                                                                max_value=max(open0,open1,open2,open3,open4,close0,close1,close2,close3,close4)
                                                                
                                                                li_large_range_tmp.append((max_value-min_value)/min_value)

                                                                min_0123value=min(open0,open2,open3,open1,close0,close2,close3,close1)
                                                                max_0123value=max(open0,open2,open3,open1,close0,close2,close3,close1)
                                                                
                                                                li_large_0123_range_tmp.append((max_0123value-min_0123value)/min_0123value)
    ...
    if len(li_code_tmp) > 0:
        ttmp=True
        tmp_dic={'code': li_code_tmp,

        'li_0grow_tmp': li_0grow_tmp,
        'li_1grow_tmp': li_1grow_tmp,
        'li_2grow_tmp': li_2grow_tmp,
        'li_3grow_tmp': li_3grow_tmp,
        'li_4grow_tmp': li_4grow_tmp,
       

        'li_1up_tmp': li_1up_tmp,
        'li_2up_tmp': li_2up_tmp,
        'li_3up_tmp': li_3up_tmp,
        'li_4up_tmp': li_4up_tmp, 


        'li_0max_tmp': li_0max_tmp,
        'li_1max_tmp': li_1max_tmp,
        'li_2max_tmp': li_2max_tmp,
        'li_3max_tmp': li_3max_tmp,
        'li_4max_tmp': li_4max_tmp,
       


        'li_0min_tmp': li_0min_tmp,
        'li_1min_tmp': li_1min_tmp,
        'li_2min_tmp': li_2min_tmp,
        'li_3min_tmp': li_3min_tmp,
        'li_4min_tmp': li_4min_tmp,
        ...
        'li_large_0123_range_tmp':li_large_0123_range_tmp,

        'li_0max_close_tmp': li_0max_close_tmp,
        'li_1max_close_tmp': li_1max_close_tmp,
        'li_2max_close_tmp': li_2max_close_tmp,
        'li_3max_close_tmp': li_3max_close_tmp,
        'li_4max_close_tmp': li_4max_close_tmp,
      

        'li_0min_close_tmp': li_0min_close_tmp,
        'li_1min_close_tmp': li_1min_close_tmp,
        'li_2min_close_tmp': li_2min_close_tmp,
        'li_3min_close_tmp': li_3min_close_tmp,
        'li_4min_close_tmp': li_4min_close_tmp,
...
tmp_df.to_csv('E:/Second_down_analysis1.csv',index=False)
